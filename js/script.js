   ...
   // $(document).ready(function() {
        ...
        $('div.menu__menuItem').on('click', function(e) {
            ...
            $('.add-remove').slick('slickAdd', '<div class="slide d-flex justify-content-center align-items-center"><div class="' + activity.classTitle + '"><p>' + activity.title + '</p><h4>' + activity.category + '</h4></div>');
            console.log(activity.title, activity.category, activity.classTitle);
